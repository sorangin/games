...
const ZULKASH_SPAWN_CHANCE = 0.005; // Super rare: 0.5% chance
...
const SPRITESHEET_CONFIG = {
    ...
    goblin: {
        ...
        unitRows: { goblin: 0, goblin_archer: 1, goblin_club: 2, goblin_netter: 3, goblin_pyromancer: 4, goblin_sapper: 5, goblin_shaman: 6, goblin_treasure_hunter: 7, orc_juggernaut: 8, goblin_shadowstalker: 9, goblin_mother: 10, vtharak: 1, zulkash: 4, zulfar: 0 }
    },
    gear: {
        ...
        sheetWidth: 120, sheetHeight: 200, iconWidth: 40, iconHeight: 40,
        unitRows: { knight: 0, archer: 1, champion: 2, rogue: 3, wizard: 4 },
        itemColumns: { flame_cloak: 0, goblin_mother_skull: 1, war_bow: 2 }
    },
    items: {
...
const UNIT_DATA = {
    knight: { name: "Knight", baseHp: 6, baseAtk: 1, mov: 3, range: 1, team: 'player', id_prefix: 'k', useSpritesheet: 'player', armor_type: 'grey' },
    archer: { name: "Archer", baseHp: 3, baseAtk: 1, mov: 2, range: 4, team: 'player', id_prefix: 'a', useSpritesheet: 'player', shootsProjectileType: 'arrow', armor_type: 'grey' },
    champion: { name: "Champion", baseHp: 5, baseAtk: 2, mov: 3, range: 1, team: 'player', id_prefix: 'c', useSpritesheet: 'player', cleaveDamage: 1, armor_type: 'grey' },
    rogue: { name: "Rogue", baseHp: 3, baseAtk: 1, mov: 5, range: 1, team: 'player', id_prefix: 'r', useSpritesheet: 'player', canStealth: true, canQuickStrike: false, armor_type: 'grey' },
    ...
    orc_juggernaut: { name: "Orc Juggernaut", baseHp: 8, baseAtk: 3, mov: 2, range: 1, team: 'enemy', id_prefix: 'oj', useSpritesheet: 'goblin', isBoss: true, dropsArmor: true, scale: 1.1, knockback: true },
    ...
    vtharak: { name: "V'tharak, Bow Master", baseHp: 8, baseAtk: 2, mov: 5, range: 6, team: 'enemy', id_prefix: 'vth', useSpritesheet: 'goblin', shootsProjectileType: 'arrow', isBoss: false, dropsWarBow: true, scale: 1.15, spriteRow: 1, baseSpriteVariant: 'green', forceCssVariant: 'purple' },
    zulkash: { name: "Zul'kash, the Blazer", baseHp: 10, baseAtk: 3, mov: 5, range: 4, team: 'enemy', id_prefix: 'zk', useSpritesheet: 'goblin', shootsProjectileType: 'fireball', isBoss: false, dropsFlameCloak: true, scale: 1.2, spriteRow: 4, baseSpriteVariant: 'green', forceCssVariant: 'gold', canCastFlameWave: true, flameWaveCooldown: PYRO_FLAME_WAVE_COOLDOWN, flameWaveRows: 2 },
    zulfar: { name: "Zul'far, the Cinder-Lord", baseHp: 10, baseAtk: 4, mov: 4, range: 5, team: 'enemy', id_prefix: 'zf', useSpritesheet: 'goblin', shootsProjectileType: 'fireball', isBoss: false, dropsFlameRing: true, scale: 1.25, spriteRow: 0, baseSpriteVariant: 'green', forceCssVariant: 'bloodOrange', fireballRadius: 1 },
    ...
    goblin_mother: { name: "Goblin Mother", baseHp: 10, baseAtk: 1, mov: 0, range: 1, team: 'enemy', id_prefix: 'gm', useSpritesheet: 'goblin', ability: 'spawnGoblins', spawnCooldown: GOBLIN_MOTHER_SPAWN_COOLDOWN, scale: 1.1, dropsGoblinMotherSkull: true },
    wizard: { name: "Wizard", baseHp: 2, baseAtk: 2, mov: 3, range: 3, team: 'player', id_prefix: 'wiz', useSpritesheet: 'player', armor_type: 'grey', canCastChainLightning: true, chainLightningCooldown: 3, canCastPolymorph: false, polymorphCooldown: 2, spriteRow: 4, shootsProjectileType: 'fireball', ignoreUnitsForLOS: true },
...
const ITEM_DATA = {
    gold: { name: 'Gold Coin', description: 'Currency', pickupAction: 'addGold', value: 1, zIndex: 9, spriteClass: 'icon-gold' },
    chest: { name: 'Chest', description: 'Contains gold and items', pickupAction: 'openChest', baseGoldAmount: CHEST_BASE_GOLD_AMOUNT, zIndex: 7, spriteClass: 'icon-chest-closed', openedSpriteClass: 'icon-chest-opened' },
    health_potion: { name: 'Health Potion', description: 'Restores HP', pickupAction: 'healUnit', value: HEALTH_POTION_HEAL_AMOUNT, zIndex: 8, spriteClass: 'icon-potion' },
    shiny_gem: { name: 'Shiny Gem', description: 'Valuable gem', pickupAction: 'addGold', valueMin: SHINY_GEM_MIN_GOLD, valueMax: SHINY_GEM_MAX_GOLD, zIndex: 8, spriteClass: 'icon-gem' },
    gold_magnet: { name: 'Gold Magnet', description: 'Pulls nearby gold!', pickupAction: 'upgradeGoldMagnet', value: 1, zIndex: 8, spriteClass: 'icon-goldmagnet' },
    spellbook: { name: 'Spellbook', description: 'Restores 1 spell charge.', pickupAction: 'restoreSpell', value: 1, zIndex: 8, spriteClass: 'icon-spellbook' },
    war_bow: { name: 'War Bow', description: '+1 RNG', pickupAction: 'unlockWarBow', value: 1, zIndex: 8, spriteClass: 'icon-warbow', color: 'var(--color-green-bright)' },
    flame_cloak: { name: 'Flame Cloak', pickupAction: 'unlockFlameCloak', value: 1, zIndex: 8, spriteClass: 'icon-flame-cloak', color: 'var(--color-orange-highlight)' },
    flame_ring: { name: 'Flame Ring', description: '<span style="color:var(--color-gold-light)">+1 Fireball radius</span>', pickupAction: 'unlockFlameRing', value: 1, zIndex: 8, spriteClass: 'icon-flame-ring', color: 'var(--color-orange-highlight)' },
    armor: { name: 'Armor', pickupAction: 'collectArmor', value: 1, zIndex: 8 },
    helmet: { name: 'Helmet', pickupAction: 'collectArmor', value: 1, zIndex: 8 }
};
...
const ARMOR_DATA = {
    ...
    none: { id: 'none', name: 'No Armor', description: 'No protection.', hpBonus: 0, atkBonus: 0, movBonus: 0, resistances: {}, activation: null, color: '#e0e0e0', iconClass: 'icon-armor-none', iconPath: './sprites/armor_none.png' },
...
const WORLD_ENEMY_POOL = {
    ...
    infinite: { common: ['goblin', 'goblin_archer'], uncommon: ['goblin_club', 'goblin_netter', 'goblin_shaman', 'goblin_sapper', 'goblin_pyromancer'], rare: ['goblin_shadowstalker', 'zulkash', 'zulfar'], boss: ['orc_juggernaut'] }
};
...
const ACHIEVEMENT_DATA = {
    ...
    lone_wolf: { title: "Lone Wolf", description: "Win a level using only a single unit.", icon: "lone_wolf", category: "challenges", condition: { type: "level_complete_condition", condition: "lone_wolf" }, reward: { gold: 50 }, sortOrder: 55 },
    no_armor_victory: { title: "Born Leader", description: "Beat any level with 'No Armor' equipped.", icon: "no_armor", category: "challenges", condition: { type: "level_complete_condition", condition: "no_armor" }, reward: { gold: 50 }, sortOrder: 56 },
    flawless_victory: { title: "Flawless Victory", description: "Beat a level with all units at full HP.", icon: "flawless", category: "challenges", condition: { type: "level_complete_condition", condition: "full_hp" }, reward: { gold: 50 }, sortOrder: 57 },
    no_losses: { title: "No One Left Behind", description: "Beat a level without losing any units.", icon: "no_losses", category: "challenges", condition: { type: "level_complete_condition", condition: "no_losses" }, reward: { gold: 40 } },
    ...
    recruit_archer: { title: "First Archer", description: "Rescue the Archer.", icon: "recruit", category: "recruitment", condition: { type: "recruit", target: "archer", count: 1 }, reward: { gold: 50 } },
    recruit_champion: { title: "First Champion", description: "Rescue the Champion.", icon: "recruit", category: "recruitment", condition: { type: "recruit", target: "champion", count: 1 }, reward: { gold: 50 } },
    recruit_rogue: { title: "First Rogue", description: "Rescue the Rogue.", icon: "recruit", category: "recruitment", condition: { type: "recruit", target: "rogue", count: 1 }, reward: { gold: 50 } },
    wizard_recruit: { title: "The Wizard", description: "Rescue the Wizard.", icon: "recruit", category: "recruitment", condition: { type: "recruit", target: "wizard", count: 1 }, reward: { gold: 80 } },
    // Collection Achievements
    full_party: { title: "Full Roster", description: "Fill your active roster to the maximum size.", icon: "full_party", category: "collection", condition: { type: "roster_full" }, reward: { gold: 50 } },
    grand_battalion: { title: "Grand Battalion", description: "Own 12 Knights at once.", icon: "recruit", category: "collection", condition: { type: "recruit", target: "knight", count: 12 }, reward: { gold: 50 } },
    legion_commander: { title: "Legion Commander", description: "Own 49 units in total.", icon: "full_party", category: "collection", condition: { type: "total_unit_count", count: 49 }, reward: { gold: 100 } },
